...
public interface SyntaxCreationStatusRepository extends KeyValueRepository<SyntaxCreationResultRedis, String> {
    Optional<SyntaxCreationResultRedis> getByNamespace(String namespace);
}
